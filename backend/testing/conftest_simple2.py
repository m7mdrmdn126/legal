...
# Create admin and test user tokens using async context manager approach
@pytest.fixture
...
@pytest.fixture
async def test_user_token(admin_token):
    ...
    async with AsyncClient(app=app, base_url=TEST_BASE_URL) as client:
        ...
        return await login_user(client, "testuser", "testpass123")
